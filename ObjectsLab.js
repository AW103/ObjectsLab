...
const favoriteThings = {
  band: "Fall Out Boy",
  food: "Potatoes",
  person: "Carter Walsh aka G.O.A.T. spouse",
  book: "SO MANY. Currently: Dark Matter by Blake Crouch.",
  movie: "SO MANY. Currently: Gladiator",
  holiday: "Christmas",
};
...
const myCat = new Cat("Hermoine", 4, "brown and black");
console.log(myCat);
...
let myWizard = new Wizard("Carter", 25, "Avada Kedavra");
...
const apple = new Phone("Iphone", "13", 128, "red", 999);
const samsung = new Phone("Galaxy", "S22 Ultra", 128, "green", 1199);
const google = new Phone("Pixel", "6 Pro", 128, "stormy", 899);
...
const myFirstVehicle = new Vehicle(5, "red", 30000);
console.log(myFirstVehicle.move(500));
...
const myFirstMotorcycle = new Motorcycle("Kawasaki", true, 1, "blue", 12000);
